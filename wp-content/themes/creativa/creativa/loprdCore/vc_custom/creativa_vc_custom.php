...
vc_map( array(
    ...
    'params' => array(
        ...
        array(
            'type' => 'checkbox',
            // 'heading' => esc_html__( 'Show Overlay', 'js_composer' ),
            'param_name' => 'common_height',
            'value' => array(
                              esc_html__( 'Columns Equal Height', 'creativa' ) => 'true',
                        ),
            // 'description' => esc_html__( 'Select background style.', 'js_composer' ),
        ...
        array(
            ...
            'heading' => esc_html__( 'Video Sources', 'js_composer' ),
...
vc_map( array(
    ...
    "params" => array(
        ...
        array(
            'type' => 'dropdown',
            'heading' => esc_html__( 'Timeline Axis Position', 'js_composer' ),
    ...
    "params" => array(
        ...
        array(
            ...
            'value' => array(
                ...
                esc_html__( 'Upload Custom Image', 'js_composer' ) => 'upload_image',
            ),
            'param_name' => 'icon',
        ...
        array(
            'type' => 'dropdown',
            'heading' => esc_html__( 'Icon Box Layout', 'js_composer' ),
...
vc_map( array(
    ...
    "params" => array(
        ...
        array(
            ...
            'edit_field_class' => 'vc_col-sm-12 vc_column sep_element',
            'value' => array(
                              esc_html__( 'Select to exclude', 'js_composer' ) => 'exclude',
                        ),
            // 'description' => esc_html__( 'Select background style.', 'js_composer' ),
            'std' => '',
            'group' => esc_html__( 'Filter by', 'creativa' ),
...
vc_map( array(
    ...
    "params" => array(
        ...
        array(
            ...
            'param_name' => 'featured',
            'value' => array(
                              esc_html__( 'Featured Column', 'js_composer' ) => 'true',
                        ),
            // 'description' => esc_html__( 'Select background style.', 'js_composer' ),
            // 'dependency' => array( 'element' => 'bg_style', 'value' => 'standard'),
            'std' => '',
...
vc_map( array(
    ...
    'params' => array(
        array(
            'type' => 'dropdown',
            'heading' => esc_html__( 'Auto rotate tabs', 'js_composer' ),
            'param_name' => 'interval',
            'value' => array( esc_html__( 'Disable', 'js_composer' ) => 0, 3, 5, 10, 15 ),
            'std' => 0,
...
vc_map( array(
    ...
    'params' => array(
        ...
        array(
            'type' => 'checkbox',
            'heading' => esc_html__( 'Allow collapsible all', 'js_composer' ),
            'param_name' => 'collapsible',
            'description' => esc_html__( 'Select checkbox to allow all sections to be collapsible.', 'js_composer' ),
            'value' => array( esc_html__( 'Allow', 'js_composer' ) => 'yes' )
        ),
        array(
            'type' => 'checkbox',
            'heading' => esc_html__( 'Disable keyboard interactions', 'js_composer' ),
            'param_name' => 'disable_keyboard',
            'description' => esc_html__( 'Disables keyboard arrows interactions LEFT/UP/RIGHT/DOWN/SPACES keys.', 'js_composer' ),
            'value' => array( esc_html__( 'Disable', 'js_composer' ) => 'yes' )
        ),
        $add_css_animation,
        $add_css_animation_delay,
        array(
    ...
    'params' => array(
        ...
        array(
            ...
            'value' => array(
                ...
                esc_html__( 'Align center', 'js_composer' ) => 'center'
            ),
        ...
        array(
            ...
            'description' => esc_html__( 'Enter URL if you want this image to have a link.', 'js_composer' ),
        ),
...
vc_map( array(
    ...
    'params' => array(
        ...
        array(
            ...
            'heading' => esc_html__( 'Image size', 'js_composer' ),
            'param_name' => 'img_size',
            'description' => esc_html__( 'Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x0 (Width x Height - 0 set image height to auto). Leave empty to use "thumbnail" size.', 'js_composer' )
        ),
        array(
            'type' => 'dropdown',
