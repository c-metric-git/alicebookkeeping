    ...
    $boxSections[] = array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'type' => 'gallery',
                'title' => esc_html__('Add/Edit Post Gallery', 'so-panels'),
                'subtitle' => esc_html__('Create a new Gallery by selecting existing or uploading new images using the WordPress native uploader', 'so-panels'),
                'desc' => esc_html__('This is the description field, again good for additional info.', 'creativa'),
                'default' => '',
            ),
        )
    ...
    $boxSections[] = array(
        ...
        'fields' => array(  
            ...
            array(
                ...
                'type' => 'gallery',
                'title' => esc_html__('Add/Edit Project Gallery', 'so-panels'),
                'subtitle' => esc_html__('Create a new Gallery by selecting existing or uploading new images using the WordPress native uploader', 'so-panels'),
                'desc' => esc_html__('This is the description field, again good for additional info.', 'creativa'),
                'default' => '',
            ),
