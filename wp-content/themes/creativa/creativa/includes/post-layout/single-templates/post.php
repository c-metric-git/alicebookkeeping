      ...
      <div class="col-md-12">
        <div class="single__title--wrap">
          <div class="entry-info">
              ...
              <span class="font-secondary"><?php esc_html_e('at', 'creativa') ?></span>
              <span class="post-date font-secondary"><?php the_time(get_option('time_format')); ?></span>
              <?php 
                  if (comments_open() && !post_password_required()) { 
                    echo '&middot; <a class="comments-link font-secondary" href="'. get_comments_link( get_the_ID() ) .'"> Comments: ';
          ...
          <div class="single__post-subtitle">
            <hr/>
